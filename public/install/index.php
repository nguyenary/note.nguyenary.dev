...
if (isset($_POST['DB_HOST'])):
    ...
    if ($db->connect_errno > 0) {
        ...
        $eprdata = str_replace('PasteShr', '"'.$site_name.'"', $eprdata);	
...
$enabled = '<i class="fa fa-check text-success"></i>';
$disabled = '<i class="fa fa-close text-danger"></i>';
?>
<!DOCTYPE html>
<html>
<head>
    <title>EcoDevs Installer</title>
 <!-- Bootstrap Core CSS -->
        ...
        <div class="col-md-12">
          <h3> Step 1 - Requirements</h3>
            ...
            <table class="table">
              ...
              <tr>
                <th colspan="2">MySQL Version 5.*</th>
              </tr>  
          ...
          <table class="table">
              ...
              <tr>
                <td>fopen (allow_url_open)</td>
                <td><?=ini_get('allow_url_fopen')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>cURL</td>
                <td><?=function_exists('curl_version')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>OpenSSL</td>
                <td><?=extension_loaded('openssl')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>PDO</td>
                <td><?=extension_loaded('pdo')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>Mbstring</td>
                <td><?=extension_loaded('mbstring')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>Tokenizer</td>
                <td><?=extension_loaded('tokenizer')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>XML</td>
                <td><?=extension_loaded('xml')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>Ctype</td>
                <td><?=extension_loaded('ctype')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>JSON</td>
                <td><?=extension_loaded('json')?$enabled:$disabled ?></td>
              </tr>
              <tr>
                <td>BCMath</td>
                <td><?=extension_loaded('bcmath')?$enabled:$disabled ?></td>
              </tr> 
              <tr>
                <td>Zip</td>
                <td><?=extension_loaded('zip')?$enabled:$disabled ?></td>
              </tr>
          </table>
