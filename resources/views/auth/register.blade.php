        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
              ...
              <hr>
              @if (config('settings.social_login_facebook') == 1) <a href="{{ route('social.login', ['provider '=> 'facebook', 'action' => 'register']) }}" class="btn btn-primary btn-block mb-1"> <i class="fa fa-facebook"></i> {{ __('Register with Facebook') }} </a> @endif
