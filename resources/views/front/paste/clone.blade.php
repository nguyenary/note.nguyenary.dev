          ...
          <div class="card-body"> @include('front.includes.messages')
            ...
            <form method="post" action="{{route('paste.store')}}">
              ...
              <div class="form-group">
                ...
                @if(config('settings.paste_editor') == 'ace')
                <textarea id="editor" class="hide">{{old('content',$paste->content)}}</textarea>
                <input type="hidden" name="content">
                  @elseif(config('settings.paste_editor') == 'codemirror')
                    <textarea id="editor" autofocus>{{old('content',$paste->content)}}</textarea>
                    <input name="content" type="hidden">
                  @else
                <textarea name="content" class="form-control" rows="15"  autofocus>{{old('content',$paste->content)}}</textarea>
                @endif
              </div>
              ...
              <hr class="extra-margin" />
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      @php $selected = old('folder_id'); @endphp
