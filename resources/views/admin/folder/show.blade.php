					...
					<div class="card">
						<div class="card-header d-flex justify-content-between">
							<span>
							  ...
							  <a href="{{ route('folders.edit',[$folder->id]) }}" class="badge badge-info ml-3"><i class="fa fa-edit"></i> {{ __('Edit') }}</a>
							  <a href="{{ route('folders.delete',[$folder->id]) }}" class="badge badge-danger ml-1"><i class="fa fa-trash"></i> {{ __('Delete') }}</a>
							</span>
							<span>
							  <form action="">
